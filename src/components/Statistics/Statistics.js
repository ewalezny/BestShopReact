            ...
            <div className={container}>
                ...
                <div className={statistics__content}>
                    <div className={statistics__box}>
                        <Circle redish />
                        <img src="../../../public/assets/Person.svg" alt="person" className={statistics__img_person}/>
                        <StatisticsBox number="100000+" text="daily entries"/>
                    </div>
                    <div className={statistics__box}>
                        <Circle primary />
                        <img src="../../../public/assets/Eye.svg" alt="eye" className={statistics__img_eye}/>
                        <StatisticsBox number="2000000+" text="seen products every day"/>
                    </div>
                    <div className={statistics__box}>
                        <Circle green />
                        <img src="../../../public/assets/Catalog.svg" alt="catalog" className={statistics__img_catalog}/>
